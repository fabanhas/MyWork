    ...
    <div class="container">
        ...
        <div class="slider-home" data-aos="fade">
            <div class="helper">
                <div class="row">
                    <div class="col-md-6">
                        <img src="assets/img/cadeira.png" class="img-fluid" alt="">
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <article class="produto" data-aos-delay="300" data-aos="fade">
                ...
                <a href="/"><img src="assets/img/cadeira-destaque.png" alt="Produto"></a>
                </div>
...
<section class="sobre">
    <div class="container">
        <div class="row">
            <div class="col-md-7" >
                <img src="assets/img/sobre.png" class="img-fluid" alt="" data-aos="fade-in" data-aos-delay="100">
            </div>
            <div class="col-md-5">
